<VirtualHost *:80>
	ServerName seabird.nexleaf.org
...
#################################
# More django setup
       WSGIDaemonProcess seabirdwebportal user=seabird group=seabird python-path=/var/www/seabird/deployed
       WSGIProcessGroup seabirdwebportal
